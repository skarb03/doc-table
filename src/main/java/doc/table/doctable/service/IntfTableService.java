    ...
    private List<String> createDDL(List<TableInfo> tableInfoList,String ownerPlace){
        ...
        for(TableInfo tableInfo : tableInfoList){
            ...
            for(ColumnInfo columnInfo : tableInfo.getColumnInfoList()){
                ...
                if(standardDict.getDataType().equals("NUMBER")){
                    String length= standardDict.getLength();
                    if(!length.contains(",")) {
                        length = removeComma(length);
                    }
...
//                    sb.append(")");
//                }
                else if(standardDict.getDataType().equals("VARCHAR")){

                    String length = removeComma(standardDict.getLength());
